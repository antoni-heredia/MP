...
/*
 ...
 No recibe nada.
*/
Matriz2D_1_ConstructorCopia::Matriz2D_1_ConstructorCopia(void):matriz(0),fils(0),
  cols(0){}
...
*/
Matriz2D_1_ConstructorCopia::Matriz2D_1_ConstructorCopia(int num):fils(num),
  cols(num){
...
/*
 ...
 columnas(cols)
*/
Matriz2D_1_ConstructorCopia::Matriz2D_1_ConstructorCopia(int filas, int colms):
...
/*
 Este constructor crea una copia profunda de otra Matriz2D_1_ConstructorCopia
 Recibe una Matriz2D_1_ConstructorCopia que seara de la cual se copien los
 datos
*/
Matriz2D_1_ConstructorCopia::Matriz2D_1_ConstructorCopia(
  Matriz2D_1_ConstructorCopia & otra){
...
/*
  ...
  No recibe nada
*/
Matriz2D_1_ConstructorCopia::~Matriz2D_1_ConstructorCopia(void){
...
*/
bool Matriz2D_1_ConstructorCopia::EstaVacia(void){
  return (matriz == 0);
}
...
*/
void Matriz2D_1_ConstructorCopia::ModificarValor (int fila, int col, TipoBase val){
  matriz[fila][col] = val;
}
...
*/
TipoBase Matriz2D_1_ConstructorCopia::LeerValor (int fila, int col){
...
/*
 ...
 No devuelve nada
*/
void Matriz2D_1_ConstructorCopia::InicializarDato(TipoBase dato){
  for(int f = 0; f < fils; f++)
...
/*
  ...
  No devuelve nada
*/
void Matriz2D_1_ConstructorCopia::Mostrar(void){
  if(matriz != 0)
    for(int f = 0; f < fils; f++){
      for(int c = 0; c < cols; c++)
        cout << matriz[f][c] << " ";
...
/*
 ...
 No devuelve nada
*/
void Matriz2D_1_ConstructorCopia::ReservaMemoria(int filas, int colms){
...
/*
  ...
  Recibe:
    -otra una Matriz2D_1_ConstructorCopia de la cual se copiara los datos
*/
void Matriz2D_1_ConstructorCopia::CopiarDatos(Matriz2D_1_ConstructorCopia & otra){
