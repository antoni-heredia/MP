...
public:
  ...
  */
  Lista_ConstructorCopia(int tamanio);
  ...
  */
  Lista_ConstructorCopia(int tamanio, TipoBase valor);

  /*
    Constructor que crea una lista que sera la copia de otra lista
    Recibe:
      -otro es una Lista_ConstructorCopia de la cual se copiaran los datos
  */
  Lista_ConstructorCopia(Lista_ConstructorCopia & otro);
...
private:
  ...
  */
  ...
  /*
    ...
    Recibe:
      -otra una Lista_ConstructorCopia de la cual se copiara los datos
  */
  void CopiarDatos(Lista_ConstructorCopia & otra);
