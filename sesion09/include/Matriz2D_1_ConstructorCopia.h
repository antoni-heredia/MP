...
class Matriz2D_1_ConstructorCopia{
...
public:
  ...
  /*
    ...
    No recibe nada.
  */
  Matriz2D_1_ConstructorCopia(void);
  ...
  */
  Matriz2D_1_ConstructorCopia(int num);
  ...
  */
  Matriz2D_1_ConstructorCopia(int fils, int cols);
  ...
  */
  Matriz2D_1_ConstructorCopia(int fils, int cols, TipoBase dato);

  /*
    Este constructor crea una copia profunda de otra Matriz2D_1_ConstructorCopia
    Recibe:
      - otra una Matriz2D_1_ConstructorCopia que seara de la cual se copien los
        datos
  */
  Matriz2D_1_ConstructorCopia(Matriz2D_1_ConstructorCopia & otra);
...
private:
  ...
  */
  void CopiarDatos(Matriz2D_1_ConstructorCopia & otra);
