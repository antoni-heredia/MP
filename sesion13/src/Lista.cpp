...
///////////////////////////////////////////////////////////////////////////////
  ...
  /***
    Constructor que recibe el nombre de un fichero de texto y rellena los nodos 
    de la lista con los datos contenidos en el fichero.
  */
  Lista::Lista(const char * nombre):tamanio(0),lista(0){
      LeerLista (nombre);
  }
...
///////////////////////////////////////////////////////////////////////////////
  ...
  */
  void Lista::RellenarNodosFichero(ifstream  &fi){
    TipoBase valor;
    while(fi >> valor){
      AniadirValor(valor);
    }
